...
//                    $li = sprintf($this->_linkSelectedTemplate, Util::formatURL($url), $page['label']);
//                } else {
                    $li = sprintf($this->_linkTemplate, Util::formatURL($url), $page['label']);
//                }
        ...
        $xhtml = '<ul  class="subnav">' . PHP_EOL . implode(PHP_EOL, $menu) . PHP_EOL . '</ul>'; //For New UI
