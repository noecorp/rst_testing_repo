...
abstract class Zend_Db_Adapter_Abstract
{
     ...
     * @throws Zend_Db_Adapter_Exception
     */
    public function multipleInsert($table, array $bind)
    {
        if(empty($bind)){        
            require_once 'Zend/Db/Adapter/Exception.php';
            throw new Zend_Db_Adapter_Exception(get_class($this) ." Agent data missing in insert");
        }
        
        foreach ($bind as $col => $val) {
           $resp = $this->insert($table, $val);
        }
        return $resp;
    }
