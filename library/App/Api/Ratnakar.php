...
/**
 * Ratnakar API Class
 * Base class for Ratnakar Remit API
 * 
 * @company Transerv
 * @author Vikram
 */
class App_Api_Ratnakar extends App_Api_Curl {
    ...
    public function creditAccount(array $param) {
        ...
        //New Format
        $string = $this->_creditMessageCode . self::DELIMITER . $date . self::DELIMITER . $this->_merchantId . self::DELIMITER . $param['traceNumber'] . self::DELIMITER . $this->_creditRequestType . self::DELIMITER . $param['beneIFSC'] . self::DELIMITER . $param['beneAccount'] . self::DELIMITER . $param['amount'] . self::DELIMITER . $remark . self::DELIMITER . $this->_beneAccountType . self::DELIMITER .$remitterName. self::DELIMITER .$remitterMobile. self::DELIMITER . self::DELIMITER . self::DELIMITER;
