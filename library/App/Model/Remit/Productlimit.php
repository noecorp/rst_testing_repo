...
class Remit_Productlimit extends App_Model
{
    /**
    ...
    public function findAll ($pid = 0,$plid = 0,$page = 1,$paginate = NULL,$force = FALSE){
       ...
       $details = $this->select()
                ->from(DbTable::TABLE_PRODUCT_LIMIT.' as pl',array(
                    ...
                    'limit_out_min_txn','limit_out_max_txn','name','currency','cnt_out_max_txn_daily','cnt_out_max_txn_monthly',
                    'cnt_out_max_txn_yearly','product_limit_code','id','customer_limit_out_max_txn','customer_limit_out_max_monthly'));
