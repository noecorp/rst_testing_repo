 ...
 * @copyright company
 */
class Corporate_Bootstrap extends App_Bootstrap_Abstract
{
    /**
    ...
    protected function _initViewHelpers() {
        ...
        $viewRenderer->view->addHelperPath('App/Corporate/View/Helper', 'App_Corporate_View_Helper');
    }
    ...
    protected function _initSetupDirectory()
    {
        ...
        //Create Cache directory if not exists
        if(!is_dir(ROOT_PATH . '/logs/corporate')) {
            mkdir(ROOT_PATH . '/logs/corporate', '0755');
        } 
    }    
