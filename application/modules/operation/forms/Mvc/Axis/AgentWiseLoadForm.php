...
class Mvc_Axis_AgentWiseLoadForm extends App_Operation_Form
{
    ...
    {  
        ...
        $agentsArr = $objAU->getAgentsForDD(array('status'=>$str, 'enroll_status'=>ENROLL_APPROVED_STATUS, 'email_verified_status'=>EMAIL_VERIFIED_STATUS, 'agent_details_status'=>AGENT_ACTIVE_STATUS,'bank_products' => 1));
