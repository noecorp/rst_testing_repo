 ...
 * Add Remitter Form
 */
class Corp_Ratnakar_UpgradeKYCForm extends App_Operation_Form
{
    ...
    {       
        ...
        $afn = new Zend_Form_Element_Text('first_name');
        $afn->setOptions(
            array(
                'label'      => 'First Name',
                'required'   => false,
        ...
        $this->addElement($afn);
        $afn->setAttrib('readonly', true);
        
        
        $afn = new Zend_Form_Element_Text('last_name');
        $afn->setOptions(
            array(
                'label'      => 'Last Name',
                'required'   => false,
        ...
        $afn = new Zend_Form_Element_Text('mobile');
        $afn->setOptions(
            array(
                'label'      => 'Mobile',
                'required'   => FALSE,
        ...
        $afn = new Zend_Form_Element_Text('email');
        $afn->setOptions(
            array(
                'label'      => 'Email',
                'required'   => FALSE,
