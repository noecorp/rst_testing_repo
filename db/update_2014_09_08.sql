INSERT INTO `api_user` (`id`, `tp_user_id`, `username`, `password`, `status`, `date_created`) VALUES (24, '24', 'shopclues', '54fr3a4557510c82d47d0ac1a5244c4eba0762b3', 'active', '0000-00-00 00:00:00');
...
INSERT INTO `api_user` (`id`, `tp_user_id`, `username`, `password`, `status`, `date_created`) VALUES (23, '21', 'payuusersec', '6b5c3a4557510c82d47d0ac1a5244c4eba07ss46', 'active', '0000-00-00 00:00:00');

INSERT INTO `api_user_ip` (`id`, `tp_user_id`, `tp_user_ip`, `date_created`) VALUES (NULL, '23', '127.0.0.1,122.160.80.129,58.68.41.26,182.71.83.66,14.140.201.162', '0000-00-00 00:00:00');

UPDATE `purse_master` SET `load_min` = '1' WHERE `purse_master`.`code` = 'PAY916';
