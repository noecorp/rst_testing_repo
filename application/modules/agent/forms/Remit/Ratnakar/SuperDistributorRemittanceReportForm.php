 ...
 * Remittance Report
 */
class Remit_Ratnakar_SuperDistributorRemittanceReportForm extends App_Agent_Form
{
    ...
    { 
        ...
        $agentList = $agentModel->getDistNameCodeList(
        ...
        $agentListMain = array_merge($agentListMain,$agentList);
   ...
   $this->addElement(new ZendX_JQuery_Form_Element_DatePicker('from_date',
        ...
        $agent = new Zend_Form_Element_Select('dist_id');
        $agent->setOptions(
            array(
                'label'      => 'Distributor',
                'filters'    => array(
        ...
        $btn = new Zend_Form_Element_Hidden('dist');
        $btn->setOptions(
            array(
                'value' => ''
            )
