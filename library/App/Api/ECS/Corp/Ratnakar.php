<?php
/**
 * ECS Corporate Ratnakar
 * 
 * Provide functionlity to handle transaction for Corporate Ratnakar Bank
 * @category API
 * @author Vikram Singh <vikram@transerv.co.in>
 * @company Transerv
 */
class App_Api_ECS_Corp_Ratnakar extends App_Api_ECS_Transactions {

    /**
     * MediAssist Cardholder Registration
     * @param array $userArr
     * @return boolean
     * @throws App_Exception
     */
    public function mediAssistCardholderRegistration(array $userArr) {
...
//        }
        ...
        try {
            ...
            $paramArray = $this->_filterMediAssistRegistrationArray($userArr);
     ...
     * @return type
     */
    private function _filterMediAssistRegistrationArray($paramArray) {
