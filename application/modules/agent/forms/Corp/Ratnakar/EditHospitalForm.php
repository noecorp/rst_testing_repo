...
class Corp_Ratnakar_EditHospitalForm extends App_Agent_Form
{
    /**
    ...
    public function init() {
        ...
        $old_terminal_id_code = new Zend_Form_Element_Hidden('old_terminal_id_code');
        $id->setOptions(
            array(
                'required' => true
            )
        );
        $this->addElement($old_terminal_id_code);
