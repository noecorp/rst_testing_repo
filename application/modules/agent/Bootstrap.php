...
class Agent_Bootstrap extends App_Bootstrap_Abstract
{
    /**
    ...
    protected function _initViewHelpers() {
        ...
        $viewRenderer->view->addHelperPath('App/Agent/View/Helper', 'App_Agent_View_Helper');
    }
    ...
    protected function _initSetupDirectory()
    {
        ...
        //Create Cache directory if not exists
        if(!is_dir(ROOT_PATH . '/logs/agent')) {
            mkdir(ROOT_PATH . '/logs/agent', '0755');
        } 
    }    
