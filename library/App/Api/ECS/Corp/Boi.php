 ...
 * ECS Corporate BOI
 * 
 * Provide functionlity to handle transaction for Corporate BOI Bank
 * @category API
 * @author Vikram Singh <vikram@transerv.co.in>
 * @company Transerv
 */
class App_Api_ECS_Corp_Boi extends App_Api_ECS_Transactions {


    public function boiNSDCCardholderRegistration(array $userArr) {
