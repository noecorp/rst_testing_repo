...
class DownloadReportsForm extends App_Operation_Form
{
    ...
    {   
        ...
        $reportListOptions = Util::getReportNames();
        
        $reportname = new Zend_Form_Element_Select('report_name');
        $reportname->setOptions(
            array(
                'label'      => 'Report Name *',
                'required'   => TRUE,
                'filters'    => array(
                ...
                'style' => 'width:210px;',
                'maxlength' => '100',
                'multioptions'    => $reportListOptions,         
            )
        );
        $this->addElement($reportname);
