...
class BcListingForm extends App_Agent_Form
{
    ...
    {   
        ...
        $bcList = new Agents();
        $bcListOptions = $bcList->getBCList(array('status'=>STATUS_UNBLOCKED, 'enroll_status'=>STATUS_APPROVED, 'user_id' => $user->id,'user_type' =>$user->user_type));
