 ...
 */
class Remit_Ratnakar_ConfirmFundTransferForm extends App_Agent_Form
{
     public function init() {
        ...
        //    )
        //);
        //$senderMsg->setAttrib('readonly', true);
        //$this->addElement($senderMsg);
        
        $submit = new Zend_Form_Element_Submit('submit_form');
        $submit->setOptions(
            array(
                'label'      => 'Confirm Transfer Fund',
                'required'   => FALSE,
                'title'       => 'Confirm Transfer Fund',
                'class'     => 'tangerine',
            )
        );
        $this->addElement($submit);
        
         $submit = new Zend_Form_Element_Submit('cancel');
        $submit->setOptions(
            array(
                'label'      => 'Cancel',
                'required'   => FALSE,
