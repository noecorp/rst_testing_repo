 ...
 * Add Remitter Form
 */
class Corp_Kotak_AddCustomerDetailsForm extends App_Agent_Form
{
    ...
    {       
        ...
        $afn = new Zend_Form_Element_Text('bc_code');
        $afn->setOptions(
            array(
                'label'      => 'Agent Code *',
                'required'   => true,
                ...
                'validators' => array(
                                    'NotEmpty',array('StringLength', false, array(5, 15)),
                                ),
                 'maxlength' => '15',
            )
        );
       ...
       $res_address2 = new Zend_Form_Element_Text('comm_address_line2');
        ...
        $pincode = new Zend_Form_Element_Select('comm_pincode');
        $pincode->setOptions(
            array(
