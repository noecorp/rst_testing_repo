...
class Zend_Auth_Adapter_DbTable implements Zend_Auth_Adapter_Interface
{
     ...
     */
     ...
     protected $_statusCondition = null;
    ...
    public function __construct(Zend_Db_Adapter_Abstract $zendDb = null, $tableName = null, $identityColumn = null,
                                $credentialColumn = null, $credentialTreatment = null ,$statusCondition = null)
    {
        ...
        if (null !== $statusCondition) {
            $this->setStatusCondition($statusCondition);
        }
    }
    ...
    protected function _authenticateCreateSelect()
    {
        ...
        if(!empty($this->_statusCondition)){
        $dbSelect->where($this->_statusCondition);}
        return $dbSelect;
    }
    ...
    {
        $this->_statusCondition = $statusCondition;
        return $this;
    }
}
