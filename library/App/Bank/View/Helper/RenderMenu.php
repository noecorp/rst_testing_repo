...
class App_View_Helper_RenderMenu extends Zend_View_Helper_Abstract
{
    ...
    protected $_linkTemplate = '<li><a href="%1$s" title="%2$s"><i class="icon-dashboard"></i>%2$s</a></li>';
     ...
     * @access protected
     */
    protected $_linkSelectedTemplate = '<li class="selected"><a class="active" href="%1$s" title="%2$s"><i class="icon-dashboard"></i>%2$s</a></li>';
    ...
    public function renderMenu(){
        ...
        $navigation = App_Bank_Navigation::getInstance()->getNavigation();
        ...
        $xhtml = '<ul class="main-menu">' . PHP_EOL . implode(PHP_EOL, $menu) . PHP_EOL . '</ul>';//For New UI
        return $xhtml;
    }
}