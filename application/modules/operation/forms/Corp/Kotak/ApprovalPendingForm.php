...
class Corp_Kotak_ApprovalPendingForm extends App_Operation_Form
{
    /**
    ...
    public function init() {
        ...
        $product_const_arr = array(PRODUCT_CONST_KOTAK_OPENLOOP_GPR);
