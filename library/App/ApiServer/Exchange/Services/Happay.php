 ...
 * @copyright transerv
 */
class App_ApiServer_Exchange_Services_Happay extends App_ApiServer_Exchange_CommonServices
{
    private $_soapServer;
    const TP_ID = TP_HAPPAY_ID;
    ...
    public function __construct($server) 
    {
        ...
        $this->setProductConst($productConst = PRODUCT_CONST_RAT_HAP);
    ...
    public function CardRegistrationRequest () {//Do not add comments for method summary
        try {
            ...
            if( !isset($resp->ProductCode) || empty($resp->ProductCode) || !$this->validateProductCode($resp->ProductCode) || !$this->validateProductCodeByConst($resp->ProductCode,PRODUCT_CONST_RAT_HAP)) {
...
//                 return self::Exception($this->getMessage('invaild_mobile'), App_ApiServer_Exchange::$INVALID_RESPONSE);
            ...
            if( !isset($resp->AddressLine2) || empty($resp->AddressLine2)) {
                 //return self::Exception("Invalid Narration", App_ApiServer_Exchange::$INVALID_RESPONSE);
            } elseif(!$this->fieldValidator((string) $resp->AddressLine2,self::FIELD_TYPE_STRING,'1','45')) {
            ...
            try {
                ...
                $params['by_api_user_id'] = HAPPAY_AGENT_ID;
            ...
            try {
               ...
               $walletCodeResponse = $object->verifyWalletCode($productId, $walletCode);
                ...
                $param = array(
                    ...
                    'by_api_user_id'        => HAPPAY_AGENT_ID,
		    'channel'               => CHANNEL_API,
                );
