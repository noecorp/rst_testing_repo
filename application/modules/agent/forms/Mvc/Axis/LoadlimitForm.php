...
class Mvc_Axis_LoadlimitForm extends App_Agent_Form
{
    ...
    {       
        $amount = $this->addElement('text', 'amount', array(
            ...
            'validators' => array('NotEmpty','Digits', array('StringLength', false, array(1, 10)),),
            'required'   => true,
            'label'      => 'Load Amount *',
            'style'     => 'width:200px;',
            'maxlength'  => '7',
        ...
        $submit = new Zend_Form_Element_Submit('btn_amount');
        $submit->setOptions(
            array(
                'label'      => 'Load Amount',
                'required'   => FALSE,
