...
class Remit_Kotakideacts_RemitterController extends App_Agent_Controller
{
    ...
    {      
        ...
        $form = new Remit_Kotak_AddRemitterDetailsForm(array(
                                                'action' => $this->formatURL('/remit_kotakideacts_remitter/adddetails'),
                                                'method' => 'post',
                                                'name'=>'frmAdddetails',
                                                'id'=>'frmAdddetails'
                                        ));  
        ...
        $product = App_DI_Definition_BankProduct::getInstance(BANK_KOTAK_IDEACTS);
               ...
               try{
                ...
                {   
                    $userData = array('mobile_country_code'=>$formData['mobile_country_code'], 
                                      ...
                                      'fee'=>$regnFee,
                                      'product_name' => KOTAK_SHMART_IDEACTS_TRANSFER
                                     );                               
...
//                                                      'amount' =>$formData['regn_fee'],
                            ...
                            try{
                               ...
                               $this->_redirect($this->formatURL('/remit_kotakideacts_remitter/registrationcomplete/'));
     ...
     public function transactionsAction() {
        ...
        $form = new Remit_Kotak_TransactionsForm(array('action' => $this->formatURL('/remit_kotakideacts_remitter/transactions'),
                    'method' => 'post',
                ));
