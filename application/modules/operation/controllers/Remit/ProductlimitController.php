<?php
/**
 * Allow the admins to manage product limits for Remit
 *
 * @category backoffice
...
class Remit_ProductlimitController extends App_Operation_Controller
{
    /**
    ...
    public function indexAction(){
        ...
        $productlimitModel = new Remit_Productlimit();
    ...
    public function addlimitAction(){
         ...
         $productModel = new Products();
         $form = new Remit_ProductLimitForm();
         $productlimitModel = new Remit_Productlimit();
        ...
        if($this->getRequest()->isPost()){
            if($form->isValid($this->getRequest()->getPost())){
               ...
               $newArr = array(
                            ...
                            'Remitter Max Amount per Txn' => $row['customer_limit_out_max_txn'],
                            'Remitter Max Amount per Month' => $row['customer_limit_out_max_txn'],
                        );
...
//                $this->_redirect('/product/limit?pid='.$id);
                $this->_redirect($this->formatURL('/remit_productlimit/index?pid='.$id));
               }
            ...
            if($form->isValid($this->getRequest()->getPost())){
               ...
               if($res == 'edited' && $update == 'updated'){
                  ...
                  $oldArr = array(
                            ...
                            'Remitter Max Amount per Txn' => $detailsArr['customer_limit_out_max_txn'],
                            'Remitter Max Amount per Month' => $detailsArr['customer_limit_out_max_txn'],
                        );
...
//                $this->_redirect('/product/limit?pid='.$detailsArr['product_id']);
                $this->_redirect($this->formatURL('/remit_productlimit/index?pid='.$detailsArr['product_id']));
               }
    ...
    public function deletelimitAction(){
         ...
         $id = $this->_getParam('id');
         $productModel = new Products();
         $form = new Remit_DeleteProductLimitForm();
         $productlimitModel = new Remit_Productlimit();
         $detailsArr = $productlimitModel->findById($id);
