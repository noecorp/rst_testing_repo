 ...
 * Add Remitter Form
 */
class Remit_Ratnakar_AddRemitterDetailsForm extends App_Agent_Form
{
...
//        $this->addElement($regnfee);
        ...
        $form1 = new Remit_Ratnakar_SearchRemitterWithEnrollRemitterForm();
        ...
        ),'serachremitter',array('legend' => 'Search Remitter'));
        
        $serachremitter = $this->getDisplayGroup('serachremitter');
        $serachremitter->setDecorators(array(
        
                    'FormElements',
                    'Fieldset',
                    array('HtmlTag',array('tag'=>'div','style'=>'clear: both; padding-bottom:30px;','id' => 'searchRemitForm'))
        ));
...
//        $this->addElement($legal_id);
	...
	$form2 = new Remit_Ratnakar_AddBeneficiaryWithRemitterDetailsForm();
...
//       $this->addElement($profile_pic);
        ...
        ),'remitter',array('legend' => 'Remitter Information'));
        
        $remitter = $this->getDisplayGroup('remitter');
        $remitter->setDecorators(array(
        ...
        $this->addDisplayGroup(array(
                ...
                'add_beni',
                'beni_name',
                'beni_bank_account_type',
                'beni_bank_account_number',
                'beni_conf_bank_account_number',
                'beni_ifsc_code',
                'beni_bank_name',
                'beni_bank_state',
                'beni_branch_city',
        ...
        ),'beneficiary',array('legend' => 'Beneficiary Information'));
        
        $beneficiary = $this->getDisplayGroup('beneficiary');
        $beneficiary->setDecorators(array(
        
                    'FormElements',
                    'Fieldset',
                    array('HtmlTag',array('tag'=>'div','style'=>'width:50%;float:left;','id' => 'beneFormArea'))
        ));
