...
class OperationUserGroup extends App_Model
{
    /**
     ...
     * @access protected
     */
    protected $_name = DbTable::TABLE_OPERATION_USERS_GROUP;
     ...
     * @access protected
     */
    protected $_rowClass = 'App_Table_OperationUserGroup';
