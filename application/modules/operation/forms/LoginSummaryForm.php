...
class LoginSummaryForm extends App_Operation_Form
{
    ...
    {   
        ...
        $userTypesArr = Util::getUserType();
        
        
        $user_type = $this->addElement('select', 'user_type', array(
            'filters'    => array('StringTrim'),
            //'validators' => array('NotEmpty', array('StringLength', false, array(12, 20)),),
            'required'   => true,
            'label'      => 'User Type: *',
            'style'     => 'width:200px;',
            'multioptions'     => $userTypesArr,
        ));
