...
class CorporateSearchForm extends App_Operation_Form
{
    /**
    ...
    public function init() {
        ...
        $searchCriteria->setOptions(
            array(
                ...
                'multioptions'    => Util::getCorporateSearchCriteria(),
                'required'   => true,
                'filters'    => array(
                                    'StringTrim',
                                    'StripTags',
        ...
        $submit->setOptions(
            array(
                'label'      => 'Search Corporate User',
                'required'   => FALSE,
                'title'       => 'Search Corporate User',
                'class'     => 'tangerine',
            )
        );
