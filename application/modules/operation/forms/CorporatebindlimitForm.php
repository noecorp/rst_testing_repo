...
class CorporatebindlimitForm extends App_Operation_Form
{
    /**
    ...
    public function init() {
        ...
        $limit = new Corporatelimit();
        $limitIdOptions = $limit->getCorporatelimits();
        ...
        $id = new Zend_Form_Element_Hidden('corporate_id');
        $id->setOptions(
            array(
                'validators' => array(
                    // either empty or numeric
        ...
        $submit->setOptions(
            array(
                'label'      => 'Assign Corporate Limit',
                'required'   => FALSE,
                'title'       => 'Assign Corporate Limit',
                'class'     => 'tangerine',
            )
        );
