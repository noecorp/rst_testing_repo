 ...
 * Add Remitter Form
 */
class Corp_Boi_AddCustomerDetailsForm extends App_Agent_Form
{
       ...
       $title = new Zend_Form_Element_Select('title');
        ...
        $afn->setOptions(
            array(
                ...
                'validators' => array(
                                    'NotEmpty',array('StringLength', false, array(5, 14)),
                                ),
                 'maxlength' => '14',
            )
        );
 	...
 	$Identification_number = new Zend_Form_Element_Text('nsdc_enrollment_no');
        ...
        $Identification_number->setOptions(
            array(
                ...
                'validators' => array(
                                    'NotEmpty', 'Digits', array('StringLength', false, array(1, 5)),
                                ),
                 'maxlength' => '10',
            )
        );
        ...
        $comm->setLabel('Marital Status *')
            ...
            ->setSeparator('    ');
          //  ->setValue('N');
        $comm->setRegisterInArrayValidator(false);
      ...
      /*  $res_country = new Zend_Form_Element_text('country_code');
       ...
       $res_address2 = new Zend_Form_Element_Text('comm_address_line2');
        ...
        /*$res_country = new Zend_Form_Element_Text('comm_country_code');
        $res_country->setOptions(
            array(
...
//        $Identification_number = new Zend_Form_Element_Text('aof_ref_num');
//        $Identification_number->setOptions(
//            array(
//                'label'      => 'AOF Reference Number *',
//                'required'   => TRUE,
//                'filters'    => array(
//                                    'StringTrim',
//                                    'StripTags',
...
//        
        ...
        */
        ...
        $this->addElement($Identification_number);*/
          ...
          $comm = new Zend_Form_Element_Radio('nomination_flg');
        $comm->setLabel('Nomination Required *')
            ->addMultiOptions(array(
                 'Y' => FLAG_YES,
                    'N' => FLAG_NO
        ...
        $this->addElement('hidden', 'minor_flg', array(
      	...
      	$this->addElement('hidden', 'nominee_minor_flag', array(
          			'value'      => "N"
        	));	
        $this->addElement('hidden', 'country_code', array(
          			'value'      => "IND"
        	));		
        $this->addElement('hidden', 'comm_country_code', array(
          			'value'      => "IND"
        	));			
        $this->addElement('hidden', 'account_type_id', array(
          			'value'      => "Saving"
        	));	
        $this->addElement('hidden', 'cust_comm_code', array(
          			'value'      => ""
        	));					
