 ...
 * @copyright transerv
 */
class App_ApiServer_Exchange_Package_Kotak_GPR extends App_ApiServer_Exchange_Package_Kotak
{
    const TP_ID = TP_KTK_GPR_ID;
    private $_soapServer;
    ...
    public function __construct($server) {
        ...
        $this->setProductConstant(PRODUCT_CONST_KOTAK_OPENLOOP_GPR);
        $this->setAgentConstant(KTK_GPR_AGENT_ID);
    }
    ...
    public function CardRegistrationRequest () {//Do not add comments for method summary
        try {
            ...
            if( !isset($resp->ProductCode) || empty($resp->ProductCode) || !$this->validateProductCode($resp->ProductCode) || !$this->validateProductCodeByConst($resp->ProductCode,PRODUCT_CONST_KOTAK_OPENLOOP_GPR)) {
...
//                 return self::Exception($this->getMessage('invaild_mobile'), App_ApiServer_Exchange::$INVALID_RESPONSE);
            ...
            try {
                ...
                $params['card_number'] = (string) $cardNumber;//$resp->CardNumber;
                $params['CardNumber'] = (string) $cardNumber;//$resp->CardNumber;
                $params['card_pack_id'] = (string) $resp->CardPackId;
               ...
               // $params['Title'] = (string) $resp->Title;
                ...
                $params['name_on_card'] = (string) $resp->NameOnCard;
               ...
               // $params['Mobile2'] = (string) $resp->Mobile2;
                ...
                $params['comm_address_line1'] = (string) $resp->CommAddressLine1;
                $params['comm_address_line2'] = (string) $resp->CommAddressLine2;
                $params['comm_city'] = (string) $resp->CommCity;
                $params['comm_state'] = (string) $resp->CommState;
               // $params['CommCountry'] = (string) $resp->CommCountry;
                $params['comm_pin'] = (string) $resp->CommPin;
             //   $params['Occupation'] = (string) $resp->Occupation;
                $params['employer_name'] = (string) $resp->EmployerName;
                $params['comm_address_line1'] = (string) $resp->EmployerAddressLine1;
                $params['comm_address_line2'] = (string) $resp->EmployerAddressLine2;
                $params['comm_city'] = (string) $resp->EmployerCity;
                $params['comm_state'] = (string) $resp->EmployerState;
              //  $params['corp_country'] = (string) $resp->EmployerCountry;
                $params['comm_pin'] = (string) $resp->EmployerPin;
              ...
              //  $params['CardDispatchDate'] = (string) $resp->CardDispatchDate;
                ...
                $params['status_bank'] = STATUS_PENDING;
              ...
              //  $obj = $object->getObject($params['ProductId'], $params);
                ...
                */
                ...
                $response = $obj->addCustomerECS_API($params);
    ...
    public function CardTransactionRequest ($obj) {//Do not add comments for method summary
        try {
            ...
            } elseif($this->isWalletAllowed(BANK_KOTAK_OPENLOOP_GPR, $resp->WalletCode)) {
                 return self::Exception("Invalid Wallet Code", App_ApiServer_Exchange::$INVALID_RESPONSE);                
            }
            ...
            try {
               ...
               $walletCodeResponse = $object->verifyWalletCode($productId, $walletCode);
                ...
                $baseTxn = new Corp_Kotak_Cardload();
                $param = array(
