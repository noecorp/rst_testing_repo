 ...
 * @copyright transerv
 */
class Corp_Ratnakar_CustomersLog extends Corp_Ratnakar {
     ...
     * @access protected
     */
    protected $_name = DbTable::TABLE_RAT_CORP_LOG_CARDHOLDER;
     ...
     */
     ...
     public function getCardholderStatus($customer_id = 0, $byType = BY_OPS,$page = 1) {
        ...
        $select = $this->select()
                ...
                ->from(DbTable::TABLE_RAT_CORP_LOG_CARDHOLDER .' as kc')
