...
//class ResendActivationCodeForm extends Zend_Form
class ResendActivationCodeForm extends App_Operation_Form
{
    ...
    {   
        ...
        $device_id = $this->addElement('text', 'DeviceID', array(
            'filters'    => array('StringTrim'),            
            //'validators' => array('NotEmpty', array('StringLength', false, array(5, 30)),),
            'required'   => false,
            'label'      => 'Device Id',
            'style'     => 'width:200px;',
            'maxlength' => '10',
